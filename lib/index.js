...
console.log(chalk.whiteBright("[+] Developer: Beby\n[+] Fork: SOCKETON - Ibra Decode"));
...
console.log(chalk.gray("--------------------"));
console.log(chalk.cyan("[!] Beby Menyediakan Kebutuhan Digital lho"))
console.log(chalk.whiteBright("wa.me/6285880099709\nt.me/Lucielefebvr\nhttps://link.speedcash.co.id/kahoshin\n"));
